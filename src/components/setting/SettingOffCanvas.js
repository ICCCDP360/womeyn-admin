...
const SettingOffCanvas = memo((props) => {
  ...
  const themeStyleAppearance = useSelector(
    SettingSelector.theme_style_appearance
  );
      ...
      >
        <Offcanvas.Header closeButton>
          ...
          <div className="d-flex gap-2">
            ...
            <OverlayTrigger
              placement="left"
              overlay={<Tooltip>Reset All Retting</Tooltip>}
            >
              <Button
            ...
            <Col md={12}>
              <div className="border border-2 rounded">
                ...
                <div className="p-3">
                  ...
                  <AdProStyleAppearance
                    themeStyleAppearance={themeStyleAppearance}
                  ></AdProStyleAppearance>
