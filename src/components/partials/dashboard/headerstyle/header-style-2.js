...
//React-bootstrap
import { Navbar, Dropdown, Form, Image, Button } from "react-bootstrap";
                  ...
                  <Card className="m-0 shadow-none ">
                    ...
                    <Card.Footer className="p-0 text-center">
                      <div className="d-grid">
                        <Link
                          to="/pro/e-commerce/order-process"
...
HeaderStyle2.displayName = "HeaderStyle2";
