            ...
            <ul className="navbar-nav">
              ...
              <Nav.Item as="li">
                <Nav.Link href="/boxedFancy">
                  ...
                  <span>Boxed Fancy</span>
                </Nav.Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Nav.Link href="#sidebar-user" role="button">
                  <i className="icon">
                    <svg
                      width="20"
                      viewBox="0 0 24 24"
                ...
                <ul className="sub-nav" id="sidebar-user">
                  <Nav.Item as="li">
                    <Nav.Link href="#">
                      <i className="icon">
                        <svg
