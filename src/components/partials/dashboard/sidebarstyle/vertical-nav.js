  ...
  return (
    <Fragment>
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        ...
        <li
          className={`${
            location.pathname === "/womeyn/product-page" ? "active" : ""
          } nav-item`}
        >
          <Link
            className={`${
        ...
        <li
          className={`${
            location.pathname === "/womeyn/service-page" ? "active" : ""
          } nav-item`}
        >
          <Link
            className={`${
        ...
        >
          <Link
            className={`${
              location.pathname === "/create-coupon" ? "active" : ""
            } nav-link `}
            aria-current="page"
          ...
          >
            <OverlayTrigger
              placement="right"
              overlay={<Tooltip>Promotions</Tooltip>}
            >
              <i className="icon">
                <svg
                  className="icon-20"
            ...
            <span className="item-name">Promotions</span>
          </Link>
        </li> */}
        <li>
