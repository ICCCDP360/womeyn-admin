        ...
        <Navbar expand="xl" className={`nav iq-navbar ${headerNavbar} `}>
            <Container fluid className="navbar-inner">
                ...
                <div className="d-flex align-items-center justify-content-between product-offcanvas">
                    ...
                    <small className="mb-0 text-capitalize">{`${location.pathname === '/dashboard' ? 'home' : '' || location.pathname === '/e-commerce/admin/admin-dashboard' ? 'admin dashboard' : '' || location.pathname === '/e-commerce/user/vendor-dashbord' ? 'vendor dashboard' : '' || location.pathname === '/e-commerce/shop-main' ? 'shop main' : '' || location.pathname === '/e-commerce/shop-left-filter' ? 'shop - left filter' : '' || location.pathname === '/e-commerce/shop-right-filter' ? 'shop - right filter' : '' || location.pathname === '/e-commerce/product-full-grid' ? 'product grid view' : '' || location.pathname === '/e-commerce/product-list' ? 'product list view' : '' || location.pathname === '/e-commerce/categories-list' ? 'categories list' : '' || location.pathname === '/e-commerce/product-details' ? 'product detail' : '' || location.pathname === '/e-commerce/product-details-3d' ? '3d product detail' : '' || location.pathname === '/e-commerce/product-details-360' ? '360 product detail' : '' || location.pathname === '/e-commerce/order-process' ? 'order process' : '' || location.pathname === '/e-commerce/invoice' ? 'invoice' : '' || location.pathname === '/e-commerce/wishlist' ? 'wishlist' : '' || location.pathname === '/e-commerce/app/user-profile' ? 'user profile' : '' || location.pathname === '/e-commerce/app/user-list' ? 'user list' : '' 
                        ...
                        <ul className="iq-nav-menu list-unstyled">
                            <Nav.Item as="li" className="active">
                                ...
                                <ul className="iq-header-sub-menu list-unstyled " id="homeData">
                                    ...
                                    <Nav.Item as="li"><Link className={`${location.pathname === '/blog/index' ? 'active' : ''} nav-link`} to="/blog/index">Blog</Link></Nav.Item>
                                    <Nav.Item as="li"><Link className={`${location.pathname === '/appointment/appointment' ? 'active' : ''} nav-link`} to="/appointment/appointment">Appointment</Link></Nav.Item>
