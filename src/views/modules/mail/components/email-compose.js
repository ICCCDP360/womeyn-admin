...
//Img
import img1 from '../../../../assets/images/email/01.png'
import img2 from '../../../../assets/images/email/02.png'
import img3 from '../../../../assets/images/email/03.png'


const EmailCompose = memo((props) => {
    const[ show1,setShow1 ]= useState('use-1')
    return (
        <Fragment>
            <div className={`email-app-details ${props.show  === 'use-1' && show1 === 'use-1' ?  'show' :'' }`} >
                <Card className="mb-0">
                    <Card.Body>
                        <div className="d-flex justify-content-between align-items-center">
                            <div className="d-flex justify-content-between">
                                <div className="email-remove submit me-2 text-primary" onClick={() => setShow1('')} >
                        ...
                        <div className="d-flex justify-content-between mt-3 flex-wrap">
                            <div>
                                <h6>Confirmation Mail for {props.senderName}</h6>
                            </div>
                            <div className="text-end text-primary">1 hr ago</div>
                        </div>
                        <div className="d-flex justify-content-start mt-4">
                            <div>
                                <Button className="btn btn-soft-secondary btn-icon rounded-circle avatar-50 d-flex align-items-center justify-content-center">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div className="ms-2">
                                <span>{props.senderName}<code className="m-0 iq-word-wrap"> &#x3C;{props.senderName}.123@gmail.com&#x3E;&#x3C;/{props.senderName}.123&#x3E;</code></span><br/>
                                <div className="dropdown">
                                    to me
                                    <svg xmlns="http://www.w3.org/2000/svg"  id={`dropdownMenuLink-${props.id}`} data-bs-toggle="dropdown" aria-expanded="false" width="10" viewBox="0 0 10 6" fill="none" role="button">
                                        <path d="M9 1L5 5L1 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                    <table className="dropdown-menu p-3" aria-labelledby={`dropdownMenuLink-${props.id}`}>
                                        <tbody>
                                            <tr>
                                                <th>from:</th>
                                                <td className="iq-word-wrap">&#x3C;{props.senderName}.123@gmail.com&#x3E;</td>
                                            </tr>
                                            <tr>
                                                <th>reply-to:</th>
                                            ...
                                            <tr>
                                                <th>subject:</th>
                                                <td>Confirmation Mail for {props.senderName}</td>
                                            </tr>
                                            <tr>
                                                <th>mailed by:</th>
                        ...
                        <div>
                            <p className="my-4">Hello Micheal,</p>
                            ...
                            <p className="mt-4 mb-0">Best regards,</p>
                            <p className="text-primary mb-4">Manager</p>
                        </div>
                        <hr />
                        <div className="d-flex justify-content-start my-4">
                            ...
                            <p className="text-primary m-0 ms-2">4 files attached</p>
                        </div>
                        <Row>
                            <Col xl="3" lg="6" md="6" className="">
                                <div className="bg-soft-secondary rounded mb-4">
                                    <div className="d-flex align-items-center p-4">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex">
                                                ...
                                                <span className="ms-2">Doc-1234.pdf</span>
                                            </div>   
                                            <div className="d-flex justify-content-between align-items-center mt-2">
                                                <span className="text-primary">2 mb</span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M12.1222 15.4361L12.1222 3.39508" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        ...
                        <Row>
                            <Col xl="3" lg="6" md="6" className=" mb-4">
                                <Image className="img-fluid w-100 rounded-1" src={img1} alt="email-img" />
                            </Col>
                            <Col xl="3" lg="6" md="6" className=" mb-4">
                                <Image className="img-fluid w-100 rounded-1" src={img2} alt="email-img"/>
                            </Col>
                            <Col xl="3" lg="6" md="6" className=" mb-4">
                                <Image className="img-fluid w-100 rounded-1" src={img3} alt="email-img"/>
                            </Col>
                            <Col xl="3" lg="6" md="6" className="">
                                <Image className="img-fluid w-100 rounded-1" src={img1} alt="email-img"/>
                            </Col>
