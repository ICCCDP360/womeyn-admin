...
import img8 from '../../../../../assets/modules/chat/images/avatar/09.png'
import img9 from '../../../../../assets/modules/chat/images/avatar/11.png'
import img10 from '../../../../../assets/modules/chat/images/avatar/09.png'
          ...
          <ul className="nav navbar-nav iq-main-menu mb-5 pb-5" id="sidebar-menu" role="tablist">
            <li className="p-3 d-flex justify-content-between">
                <div className="dropdown">
                    <button className="btn btn-sm btn-border rounded-pill d-flex align-items-center dropdown-toggle" id="meet_now" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="meet_now">
                        <li><Link className="dropdown-item" to="#">Create Room</Link></li>
                        <li><Link className="dropdown-item" to="#">Join Room</Link></li>
                    </ul>
                </div>
                <div className="dropdown">
                    <button className="btn btn-sm btn-border rounded-pill d-flex align-items-center dropdown-toggle" id="new_chat" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="new_chat">
            ...
            <Userlist id="101" userName="Ellyse Perry"     status="online"  lastMessage="today"      userProfileImg={img2} userMessage="I have share some media you can enjoy."             className={props.show === '1' ? 'active' : ''}  onclick={() => props.event('1')}  />
            <Userlist id="102" userName="Faf Du Plessis"                    lastMessage="today"      userProfileImg={img1} userMessage="What are you doing?"   unreadMessage="5"            className={props.show === '2' ? 'active' : ''}  onclick={() => props.event('2')} />
            <Userlist id="103" userName="Brendon McCullum"                  lastMessage="yesterday"  userProfileImg={img3} userMessage="You have time for my task?"                         className={props.show === '3' ? 'active' : ''}  onclick={() => props.event('3')} />
            <Userlist id="104" userName="Wade Johnson"                      lastMessage="yesterday"  userProfileImg={img5} userMessage="I want some teachnic for fast code can you help?"   className={props.show === '4' ? 'active' : ''}  onclick={() => props.event('4')}  />
            <Userlist id="105" userName="Arlene Cyrus"     status="online"  lastMessage="20-03-2021" userProfileImg={img4} userMessage="How are you?"                                       className={props.show === '5' ? 'active' : ''}  onclick={() => props.event('5')} />
            <Userlist id="106" userName="Darlene Warner"   status="online"  lastMessage="10-03-2021" userProfileImg={img8} userMessage="I have share some media you can enjoy."             className={props.show === '6' ? 'active' : ''}  onclick={() => props.event('6')} />
            <Userlist id="107" userName="Jenny Wilson"                      lastMessage="01-03-2021" userProfileImg={img9} userMessage="You have time for for my task?"                     className={props.show === '7' ? 'active' : ''}  onclick={() => props.event('7')} />
            <Userlist id="108" userName="Devon Lane"       status="online"  lastMessage="25-02-2021" userProfileImg={img10} userMessage="What are you doing?"                               className={props.show === '8' ? 'active' : ''}  onclick={() => props.event('8')} />
            <Userlist id="109" userName="Christopher"                       lastMessage="23-01-2021" userProfileImg={img7} userMessage="You have time for for my task?"                     className={props.show === '9' ? 'active' : ''}  onclick={() => props.event('9')} />
            <Userlist id="110" userName="Rachel Green"     status="online"  lastMessage="04-12-2020" userProfileImg={img6} userMessage="I want some teachnic for fast code can you help?"   className={props.show === '10' ? 'active' : ''} onclick={() => props.event('10')} />
            <li className="nav-item static-item">
                <Link className="nav-link static-item disabled" to="#" tabIndex="-1">
