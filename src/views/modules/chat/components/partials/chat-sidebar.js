...
//Chat-vartical-nav
import Chatvarticalnav from './chat-vartical-nav'

// Component
import Modalvideo from '../modal-video'
import Modalcalling from '../modal-calling'
...
const Chatsidebar = memo((props) => {
    ...
    return (
        <Fragment>
            <aside className="sidebar sidebar-chat sidebar-base left-bordered border-end shadow-none" data-sidebar="responsive">
                <div className="chat-header">
                    <div className="d-flex nav nav-link align-items-center gap-3 pt-3 flex-nowrap">
                        <div className="position-relative">
                            <div className="avatar-60 rounded-pill text-primary btn-icon bg-body">
                            ...
                            <span className="iq-profile-badge bg-success"></span>
                        </div>
                        <div className="d-flex w-100 justify-content-between align-items-center">
                            <div className="d-flex flex-column gap-1">
                                <div className="d-flex align-items-center gap-1">
                                    <h5 className="mb-0 text-ellipsis short-1" >Ross Taylor</h5>
                                    <Dropdown className="dropdown d-inline-flex ms-auto">
                                        ...
                                        <Dropdown.Menu as="ul" align='end'>
                                            <li>
                                                <Dropdown.Item  className=" d-flex gap-2" onClick={handleShow} >
                                            ...
                                            <li>
                                                <Dropdown.Item  className=" d-flex gap-2" onClick={handleShow1} >
                                                    <span className="d-flex">
                                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li>
                                                <Dropdown.Item  className=" d-flex gap-2" onClick={handleShow2} >
                                                    <span className="d-flex">
                                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li>
                                                <Dropdown.Item  className=" d-flex gap-2" onClick={handleShow3} >
                                                    <span className="d-flex">
                                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="sidebar-toggle d-block d-xl-none" data-toggle="sidebar" data-active="true" onClick={minisidebar}>
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="nav">
                        <div className="form-group input-group search-input px-3 mt-3 mb-2 w-100">
                    ...
                    <nav className="mb-3">
                        <Nav className="nav-tabs iq-chat-tab">
                            <Nav.Link as="button" className="d-flex flex-column align-items-center gap-2 active">
                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M12.02 2C6.21 2 2 6.74 2 12C2 13.68 2.49 15.41 3.35 16.99C3.51 17.25 3.53 17.58 3.42 17.89L2.75 20.13C2.6 20.67 3.06 21.07 3.57 20.91L5.59 20.31C6.14 20.13 6.57 20.36 7.081 20.67C8.541 21.53 10.36 21.97 12 21.97C16.96 21.97 22 18.14 22 11.97C22 6.65 17.7 2 12.02 2Z" fill="currentColor"></path>
                                    <path fillRule="evenodd" clipRule="evenodd" d="M11.9807 13.2901C11.2707 13.2801 10.7007 12.7101 10.7007 12.0001C10.7007 11.3001 11.2807 10.7201 11.9807 10.7301C12.6907 10.7301 13.2607 11.3001 13.2607 12.0101C13.2607 12.7101 12.6907 13.2901 11.9807 13.2901ZM7.37033 13.2901C6.67033 13.2901 6.09033 12.7101 6.09033 12.0101C6.09033 11.3001 6.66033 10.7301 7.37033 10.7301C8.08033 10.7301 8.65033 11.3001 8.65033 12.0101C8.65033 12.7101 8.08033 13.2801 7.37033 13.2901ZM15.3105 12.0101C15.3105 12.7101 15.8805 13.2901 16.5905 13.2901C17.3005 13.2901 17.8705 12.7101 17.8705 12.0101C17.8705 11.3001 17.3005 10.7301 16.5905 10.7301C15.8805 10.7301 15.3105 11.3001 15.3105 12.0101Z" fill="currentColor"></path>
                                </svg>
                            ...
                            <Nav.Link as="button" className="d-flex flex-column align-items-center gap-2">
                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M14.4183 5.49C13.9422 5.40206 13.505 5.70586 13.4144 6.17054C13.3238 6.63522 13.6285 7.08891 14.0916 7.17984C15.4859 7.45166 16.5624 8.53092 16.8353 9.92995V9.93095C16.913 10.3337 17.2675 10.6265 17.6759 10.6265C17.7306 10.6265 17.7854 10.6215 17.8412 10.6115C18.3043 10.5186 18.609 10.0659 18.5184 9.60018C18.1111 7.51062 16.5027 5.89672 14.4183 5.49Z" fill="currentColor"></path>
                                    <path opacity="0.4" d="M14.3558 2.00793C14.1328 1.97595 13.9087 2.04191 13.7304 2.18381C13.5472 2.32771 13.4326 2.53557 13.4078 2.76841C13.355 3.23908 13.6946 3.66479 14.1646 3.71776C17.4063 4.07951 19.9259 6.60477 20.2904 9.85654C20.3392 10.2922 20.7047 10.621 21.1409 10.621C21.1738 10.621 21.2057 10.619 21.2385 10.615C21.4666 10.59 21.6698 10.4771 21.8132 10.2972C21.9556 10.1174 22.0203 9.89351 21.9944 9.66467C21.5403 5.60746 18.4002 2.45862 14.3558 2.00793Z" fill="currentColor"></path>
                                    <path fillRule="evenodd" clipRule="evenodd" d="M11.0317 12.9724C15.0208 16.9604 15.9258 12.3467 18.4656 14.8848C20.9143 17.3328 22.3216 17.8232 19.2192 20.9247C18.8306 21.237 16.3616 24.9943 7.6846 16.3197C-0.993478 7.644 2.76158 5.17244 3.07397 4.78395C6.18387 1.67385 6.66586 3.08938 9.11449 5.53733C11.6544 8.0765 7.04266 8.98441 11.0317 12.9724Z" fill="currentColor"></path>
                ...
                <div className="sidebar-body pt-0 data-scrollbar mb-5 pb-5" id="my-scrollbar">
                    <Chatvarticalnav show={props.show}  event={props.event} />
           ...
           <Modalcalling show={show1} handleClose={handleClose1} />
           <Modalmessage show={show2}  handleClose={handleClose2} />
           <ModalContact show={show3}  handleClose={handleClose3} />
            {/* modal end*/}
        </Fragment>
    )
}
