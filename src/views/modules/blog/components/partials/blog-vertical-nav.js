    ...
    return (
        <Fragment>
            <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
                <Nav.Item as="li" className={`${location.pathname === '/blog/index' ? 'active' : ''} nav-link`}>
                    <Link className={`${location.pathname === '/blog/index' ? 'active' : ''} nav-link`} to="/blog/index">
                        <i className="icon">
                ...
                <Nav.Item as="li" className={`${location.pathname === '/blog/blog-main' ? 'active' : '' || location.pathname === '/blog/blog-details' ? 'active' : '' || location.pathname === '/blog/blog-grid' ? 'active' : '' || location.pathname === '/blog/blog-list' ? 'active' : '' || location.pathname === '/blog/blog-trending' ? 'active' : ''}`}>
                    <Link className="nav-link" data-bs-toggle="collapse" to="#blog1" role="button" aria-expanded="false" aria-controls="blog">
                        <i className="icon">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul className="sub-nav collapse" id="blog1" data-bs-parent="#blog1">
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/blog/blog-main' ? 'active' : ''} nav-link`} to="/blog/blog-main">
                                <i className="icon">
                                ...
                                <span className="item-name">Blog Main</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/blog/blog-details' ? 'active' : ''} nav-link`} to="/blog/blog-details">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span className="item-name">Blog Details</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/blog/blog-grid' ? 'active' : ''} nav-link`} to="/blog/blog-grid">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/blog/blog-list' ? 'active' : ''} nav-link`} to="/blog/blog-list">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/blog/blog-trending' ? 'active' : ''} nav-link`} to="/blog/blog-trending" >
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span className="item-name">Blog Trending</span>
                            </Link>
                        </Nav.Item>
                    </ul>
                </Nav.Item>
                <Nav.Item as="li">
                    <Link className={`${location.pathname === '/blog/blog-comments' ? 'active' : ''} nav-link`} to="/blog/blog-comments"  >
                        <i className="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
