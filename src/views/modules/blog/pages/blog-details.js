                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Card className=" shadow-none bg-transparent border mb-3">
                                <Card.Body>
                                    <div className="d-flex flex-sm-nowrap flex-wrap justify-content-center">
                                        <div>
                                            <Image className="img-fluid object-contain avatar-120 rounded-0" src={img4} alt="01"/>
                                        </div>
                                        <div className="ms-0 ms-sm-3">
                                            <div className="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                                ...
                                                <Link className="text-dark" to="/" onClick={(e) => e.preventDefault()}>Reply</Link>
                                            </div>
                            ...
                            <Card className="shadow-none bg-transparent border ms-5">
                                <Card.Body>
                                    <div className="d-flex flex-sm-nowrap flex-wrap justify-content-center">
                                        <div>
                                            <Image className="img-fluid object-contain avatar-120 rounded-0" src={img5} alt="01"/>
                                        </div>
                                        <div className="ms-0 ms-sm-3">
                                            <div className="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                ...
                                <Card.Body>
                                    <div className="d-flex flex-sm-nowrap flex-wrap justify-content-center">
                                        ...
                                        <div className="ms-0 ms-sm-3">
                                            <div className="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                                <h6 className="mb-0">Jackson Jones</h6>
                                                <Link className="tex-dark" to="/" onClick={(e) => e.preventDefault() }>Reply</Link>
                                            </div>
                                            <small className="text-primary">March 13th 2021</small>
                                            <p className="mt-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut eu morbi tincidunt erat egestas quisque ultrices ut. Vel elementum blandit et tellus sit tincidunt.</p>
                                            <div className="d-flex mb-3">
                                                <Link  to="/" onClick={(e) => e.preventDefault() }>Reply To Jackson Jones</Link>
                                                <Link className="text-body ms-3" to="/" onClick={(e) => e.preventDefault() }>Cancel Reply</Link>
                                            </div>
                                            <Col lg="12">
                                ...
                                <Row>
                                    <Col lg="6">
                                        <Form.Group className="form-group">
                                            ...
                                            <Form.Control type="text" id="full-name" placeholder="John "/>
                                        </Form.Group>
                                    </Col>
                                    <Col lg="6">
                                        <Form.Group className="form-group">
                                            <Form.Label htmlFor="last-name">Email ID</Form.Label>
                                            <Form.Control type="text" id="last-name" placeholder="XYZ@exampleemail.com  "/>
                                        </Form.Group>
                                    </Col>
                                    <Col lg="12">
                                        <Form.Group className="form-group">
                                            <Form.Label htmlFor="message">Enter your Comment</Form.Label>
                                            <Form.Control type="text" id="message" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit  "/>
                                        </Form.Group>
                                    </Col>
                                    <Col lg="12" className="d-flex justify-content-between">
                                        <Form.Check  className="form-check mb-3">
                                            <Form.Check.Input type={'checkbox'}  isValid={false} />
                                            <Form.Check.Label>Save my name and email in this browser for the next time I comment.</Form.Check.Label>
                                        </Form.Check>
                                    </Col>
                                    <div className="d-flex">
                ...
                <Col lg="4">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center ">
                                <Image className="img-fluid rounded-circle avatar-130" src={img3} alt="user-img"/>
                                <div className="ms-3">
                                    ...
                                    <Link to="/" onClick={(e) => e.preventDefault() } >
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M23.9998 12C23.9998 5.37234 18.6273 0 12.0007 0C5.37201 0 0 5.37218 0 12C0 18.6268 5.37217 24 12.0007 24C18.6275 24 23.9998 18.6268 23.9998 12Z" fill="#3D83D9"/>
                                            <path d="M9.06396 9.07227H6.28613V17.011H9.06396V9.07227Z" fill="white"/>
                                            <path d="M7.67514 5.10254C6.80501 5.10254 6.12388 5.90215 6.32007 6.80286C6.43403 7.32607 6.86083 7.74668 7.38588 7.85212C8.28124 8.03193 9.06397 7.35414 9.06397 6.49153C9.06397 5.72568 8.44333 5.10254 7.67514 5.10254Z" fill="white"/>
                                            <path d="M18.1938 11.511C18.0069 10.0148 17.2585 9.07227 15.2358 9.07227C13.8002 9.07227 13.2293 9.29619 12.9001 9.92284V9.07227H10.6514V17.011H12.9656V12.8554C12.9656 11.818 13.1622 11.0344 14.4449 11.0344C15.7092 11.0344 15.8108 11.9988 15.8108 12.9228V17.0112H18.1939C18.1938 17.0112 18.2379 11.8608 18.1938 11.511Z" fill="white"/>
                                        </svg>
                                    </Link>
                                    <Link to="/" onClick={(e) => e.preventDefault() }>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M24.0002 11.9992C24.0002 5.37225 18.6279 0 12 0C5.37242 0 0 5.37225 0 11.9992C0 18.6262 5.37242 24 12 24C18.6281 24 24.0002 18.6262 24.0002 11.9992Z" fill="#395196"/>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <Image className="img-fluid fit-img mb-4 object-cover iq-recent-post w-100" src={img2} alt="01"/>
                            ...
                            <div className="d-flex gap-2">
                                <Link to="/blog/blog-main" className="text-body">Travel</Link><span className="ms-2 me-2"> | </span>
                                <Link to="/blog/blog-main" className="text-primary">Jenny Wilson</Link>
                            </div>
                            <p className="pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut eu morbi tincidunt </p>
                            <Button type="submit" className=" mt-2 rounded">Read More</Button>
                        </Card.Body>
                    </Card>
                    <Card>
                        <Card.Body>
                            ...
                            <ul className="iq-col-masonry logik-blogtag list-unstyled gap-3">
                                <li >
                                    <Link to="/" onClick={(e) => e.preventDefault()} className="bg-soft-primary rounded-pill iq-custom-badge"><span>#Care</span></Link>
                                </li>
                                <li >
                                    <Link to="/" onClick={(e) => e.preventDefault()} className="bg-soft-primary rounded-pill iq-custom-badge">
                                        <span>#Beauty</span>
                                    </Link>
                                </li>
                                <li >
                                ...
                                <li >
                                    <Link to="/" onClick={(e) => e.preventDefault()} className="bg-soft-primary rounded-pill iq-custom-badge"><span>#SkinCare</span></Link></li>
                                <li >
                                    <Link to="/" onClick={(e) => e.preventDefault()} className="bg-soft-primary rounded-pill iq-custom-badge">
                                        <span>#Serum</span>
                                    </Link>
                                ...
                                <li ><Link to="/" onClick={(e) => e.preventDefault()} className="bg-soft-primary rounded-pill iq-custom-badge">
                                    <span>#Radiant</span>
                                    </Link>
                                </li>
                            </ul> 
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-grid gap-3 grid-cols-2">
                                <Link  to="#">
                                    <svg width="6" className="me-1" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
