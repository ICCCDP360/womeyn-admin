...
import img3 from '../../../../assets/images/table/7.png'
import img4 from '../../../../assets/images/table/4.png'
import img5 from '../../../../assets/images/table/6.png'
import img6 from '../../../../assets/images/table/8.png'
import img7 from '../../../../assets/images/table/9.png'
import img8 from '../../../../assets/images/table/3.png'
import img9 from '../../../../assets/images/table/5.png'

const Blogcomments = memo(() => {
                                    ...
                                    <tr key={index}>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img className="rounded img-fluid avatar-65 me-3" src={item.img} alt="" loading="lazy" />
                                        ...
                                        <td className="text-dark">{item.desc}</td>
                                        ...
                                        <td>
                                            <div className="d-flex gap-3 justify-content-center">
                                                <Link className="btn btn-primary btn-icon btn-sm rounded-pill" to="/blog/blog-category" role="button">
