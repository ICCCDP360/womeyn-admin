                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-between">
                                <div className="d-flex flex-wrap align-items-center">
                                    <div className="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                        <h4 className="me-2 h4">Button Hover</h4>
                                    </div>
                                </div>
                                <small>For more Information regarding Button Hover Plugin refer
                                    <Button href="https://ianlunn.github.io/Hover/#effects" target="_blank" bsPrefix="" >Documentation</Button>
                                </small>
                            </div>
                        </Card.Body>
                    </Card>
            ...
            <Row>
                <Col lg="12">
                    <Card>
                        ...
                        <Card.Body className="text-center">
                            <div className="iq-plugins-btn">
                                <Button href="#" className=" me-4  hvr-grow ">hvr-grow</Button>
                                <Button href="#" className="me-4 hvr-shrink ">hvr-shrink</Button>
                                <Button href="#" className="me-4 hvr-wobble-to-bottom-right">hvr-wobble-to-bottom-right</Button>
                                <Button href="#" className="me-4 hvr-pulse">hvr-pulse</Button>
                                <Button href="#" className="me-4 hvr-pulse-grow">hvr-pulse-grow</Button>
                                <Button href="#" className="me-4 hvr-push">hvr-push</Button>
                                <Button href="#" className="me-4 hvr-grow-rotate">hvr-grow-rotate</Button>
                                <Button href="#" className="me-4 hvr-pop">hvr-pop</Button>
                                <Button href="#" className="me-4 hvr-wobble-to-top-right">hvr-wobble-to-top-right</Button>
                                <Button href="#" className="me-4 hvr-bounce-in">hvr-bounce-in</Button>
                                <Button href="#" className="me-4 hvr-bounce-out">hvr-bounce-out</Button>
                                <Button href="#" className="me-4 hvr-rotate">hvr-rotate</Button>
                                <Button href="#" className="me-4 hvr-wobble-bottom">hvr-wobble-bottom</Button>
                                <Button href="#" className="me-4 hvr-wobble-vertical">hvr-wobble-vertical</Button>
                                <Button href="#" className="me-4 hvr-skew-forward">hvr-skew-forward</Button>
                                <Button href="#" className="me-4 hvr-skew-backward">hvr-skew-backward</Button>
                                <Button href="#" className="me-4 hvr-bob">hvr-bob</Button>
                                <Button href="#" className="me-4 hvr-hang">hvr-hang</Button>
                                <Button href="#" className="me-4 hvr-wobble-horizontal">hvr-wobble-horizontal</Button>
                                <Button href="#" className="me-4 hvr-skew">hvr-skew</Button>
                                <Button href="#" className="me-4 hvr-wobble-skew">hvr-wobble-skew</Button>
                                <Button href="#" className="me-4 hvr-buzz">hvr-buzz</Button>
                                <Button href="#" className="me-4 hvr-wobble-top">hvr-wobble-top</Button>
                                <Button href="#" className="me-4 hvr-float">hvr-float</Button>
                                <Button href="#" className="me-4 hvr-sink">hvr-sink</Button>
                                <Button href="#" className="me-4 hvr-buzz-out">hvr-buzz-out</Button>
                                <Button href="#" className="me-4 hvr-forward">hvr-forward</Button>
                                <Button href="#" className="me-4 hvr-backward">hvr-backward</Button>
                                <Button href="#" className="me-4 hvr-grow">hvr-grow</Button>
                                <Button href="#" className="me-4 hvr-shrink">hvr-shrink</Button>
                                <Button href="#" className="me-4 hvr-wobble-to-bottom-right">hvr-wobble-to-bottom-right</Button>
                                <Button href="#" className="me-4 hvr-pulse">hvr-pulse</Button>
                    ...
                    <Card>
                        <Card.Header >
                            <Card.Header.Title>
                                ...
                                <p>In this method, selecting only one option from a lots of options while only using up as much space as
                                    a single option excepted.</p>
                            </Card.Header.Title>
                        </Card.Header>
                        <Card.Body className="text-center">
                            <div className="iq-plugins-btn">
                                <Button href="#" className="me-4  hvr-fade">Fade</Button>
                                <Button href="#" className="me-4  hvr-sweep-to-right">Sweep To Right</Button>
                                <Button href="#" className="me-4  hvr-sweep-to-left">Sweep To Left</Button>
                                <Button href="#" className="me-4  hvr-sweep-to-bottom">Sweep To Bottom</Button>
                                <Button href="#" className="me-4  hvr-sweep-to-top">Sweep To Top</Button>
                                <Button href="#" className="me-4  hvr-bounce-to-right">Bounce To Right</Button>
                                <Button href="#" className="me-4  hvr-bounce-to-left">Bounce To Left</Button>
                                <Button href="#" className="me-4  hvr-bounce-to-bottom">Bounce To Bottom</Button>
                                <Button href="#" className="me-4  hvr-bounce-to-top">Bounce To Top</Button>
                                <Button href="#" className="me-4  hvr-rectangle-out">Rectangle Out</Button>
                                <Button href="#" className="me-4  hvr-radial-out">Radial Out</Button>
                                <Button href="#" className="me-4  hvr-shutter-out-horizontal">Shutter Out Horizontal</Button>
                                <Button href="#" className="me-4  hvr-shutter-out-vertical">Shutter Out Vertical</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col lg="12">
                    <Card>
                        <Card.Header>
                            <Card.Header.Title>
                                <h4>Icons</h4>
                                <small>Demo font icons courtesy of <Link to="https://fortawesome.github.io/Font-Awesome/">FontAwesome</Link>. <Link to="https://github.com/IanLunn/Hover/#using-icon-effects">How to use icons</Link> with Hover.css.</small>
                            </Card.Header.Title>
                        </Card.Header>
                        <Card.Body className=" text-center">
                            <div className="iq-plugins-btn">
                                <Button href="#" className="me-4  hvr-icon-back">
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M2 12C2 6.48 6.49 2 12 2L12.2798 2.00384C17.6706 2.15216 22 6.57356 22 12C22 17.51 17.52 22 12 22C6.49 22 2 17.51 2 12ZM13.98 16C14.27 15.7 14.27 15.23 13.97 14.94L11.02 12L13.97 9.06C14.27 8.77 14.27 8.29 13.98 8C13.68 7.7 13.21 7.7 12.92 8L9.43 11.47C9.29 11.61 9.21 11.8 9.21 12C9.21 12.2 9.29 12.39 9.43 12.53L12.92 16C13.06 16.15 13.25 16.22 13.44 16.22C13.64 16.22 13.83 16.15 13.98 16Z" fill="currentColor"></path>
                                    </svg>
                                    Icon Back
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-forward">
                                    Icon Forward
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M22 12C22 17.52 17.51 22 12 22L11.7202 21.9962C6.32942 21.8478 2 17.4264 2 12C2 6.49 6.48 2 12 2C17.51 2 22 6.49 22 12ZM10.02 8C9.73 8.3 9.73 8.77 10.03 9.06L12.98 12L10.03 14.94C9.73 15.23 9.73 15.71 10.02 16C10.32 16.3 10.79 16.3 11.08 16L14.57 12.53C14.71 12.39 14.79 12.2 14.79 12C14.79 11.8 14.71 11.61 14.57 11.47L11.08 8C10.94 7.85 10.75 7.78 10.56 7.78C10.36 7.78 10.17 7.85 10.02 8Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className=" me-4  hvr-icon-down">
                                    Icon Down
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M12 22C6.48 22 2 17.51 2 12C2 6.48 6.48 2 12 2C17.51 2 22 6.48 22 12C22 17.51 17.51 22 12 22ZM16 10.02C15.7 9.73 15.23 9.73 14.94 10.03L12 12.98L9.06 10.03C8.77 9.73 8.29 9.73 8 10.02C7.7 10.32 7.7 10.79 8 11.08L11.47 14.57C11.61 14.71 11.8 14.79 12 14.79C12.2 14.79 12.39 14.71 12.53 14.57L16 11.08C16.15 10.94 16.22 10.75 16.22 10.56C16.22 10.36 16.15 10.17 16 10.02Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-up">
                                    Icon Up
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M12 2C17.52 2 22 6.49 22 12L21.9962 12.2798C21.8478 17.6706 17.4264 22 12 22C6.49 22 2 17.52 2 12C2 6.49 6.49 2 12 2ZM8 13.98C8.3 14.27 8.77 14.27 9.06 13.97L12 11.02L14.94 13.97C15.23 14.27 15.71 14.27 16 13.98C16.3 13.68 16.3 13.21 16 12.92L12.53 9.43C12.39 9.29 12.2 9.21 12 9.21C11.8 9.21 11.61 9.29 11.47 9.43L8 12.92C7.85 13.06 7.78 13.25 7.78 13.44C7.78 13.64 7.85 13.83 8 13.98Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-spin">
                                    Icon Spin
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-drop">
                                    Icon Drop
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-fade">
                                    Icon Fade
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-float-away">
                                    Icon Float Away
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-sink-away">
                                    Icon Sink Away
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-pulse">
                                    Icon Pulse
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-pulse-grow">
                                    Icon Pulse Grow
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-wobble-horizontal">
                                ...
                                <Button href="#" className="me-4  hvr-icon-pulse-shrink">
                                    Icon Pulse Shrink
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M11.7281 21.9137C11.8388 21.9715 11.9627 22.0009 12.0865 22C12.2103 21.999 12.3331 21.9686 12.4449 21.9097L16.0128 20.0025C17.0245 19.4631 17.8168 18.8601 18.435 18.1579C19.779 16.6282 20.5129 14.6758 20.4998 12.6626L20.4575 6.02198C20.4535 5.25711 19.9511 4.57461 19.2082 4.32652L12.5707 2.09956C12.1711 1.96424 11.7331 1.96718 11.3405 2.10643L4.72824 4.41281C3.9893 4.67071 3.496 5.35811 3.50002 6.12397L3.54231 12.7597C3.5554 14.7758 4.31448 16.7194 5.68062 18.2335C6.3048 18.9258 7.10415 19.52 8.12699 20.0505L11.7281 21.9137ZM10.7836 14.1089C10.9326 14.2521 11.1259 14.3227 11.3192 14.3207C11.5125 14.3198 11.7047 14.2472 11.8517 14.1021L15.7508 10.2581C16.0438 9.96882 16.0408 9.50401 15.7448 9.21866C15.4478 8.9333 14.9696 8.93526 14.6766 9.22454L11.3081 12.5449L9.92885 11.2191C9.63186 10.9337 9.15467 10.9367 8.8607 11.226C8.56774 11.5152 8.57076 11.98 8.86775 12.2654L10.7836 14.1089Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-push">
                                    Icon Push
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Button href="#" className="me-4  hvr-icon-pop">
                                    Icon Pop
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M12 22C6.48 22 2 17.53 2 12C2 6.48 6.48 2 12 2C17.53 2 22 6.48 22 12C22 17.53 17.53 22 12 22ZM15.19 15.71C15.31 15.78 15.44 15.82 15.58 15.82C15.83 15.82 16.08 15.69 16.22 15.45C16.43 15.1 16.32 14.64 15.96 14.42L12.4 12.3V7.68C12.4 7.26 12.06 6.93 11.65 6.93C11.24 6.93 10.9 7.26 10.9 7.68V12.73C10.9 12.99 11.04 13.23 11.27 13.37L15.19 15.71Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-bounce">
                                    Icon Bounce
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.131 7.36922C13.189 7.42572 13.437 7.63906 13.641 7.8378C14.924 9.00292 17.024 12.0424 17.665 13.6332C17.768 13.8748 17.986 14.4856 18 14.812C18 15.1247 17.928 15.4228 17.782 15.7073C17.578 16.0619 17.257 16.3463 16.878 16.5022C16.615 16.6025 15.828 16.7584 15.814 16.7584C14.953 16.9143 13.554 17 12.008 17C10.535 17 9.193 16.9143 8.319 16.7867C8.305 16.772 7.327 16.6162 6.992 16.4457C6.38 16.133 6 15.5222 6 14.8685V14.812C6.015 14.3863 6.395 13.491 6.409 13.491C7.051 11.9859 9.048 9.01656 10.375 7.82319C10.375 7.82319 10.716 7.48709 10.929 7.34096C11.235 7.11301 11.614 7 11.993 7C12.416 7 12.81 7.12762 13.131 7.36922Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-rotate">
                                    Icon Rotate
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M11.5317 12.4724C15.5208 16.4604 16.4258 11.8467 18.9656 14.3848C21.4143 16.8328 22.8216 17.3232 19.7192 20.4247C19.3306 20.737 16.8616 24.4943 8.1846 15.8197C-0.493478 7.144 3.26158 4.67244 3.57397 4.28395C6.68387 1.17385 7.16586 2.58938 9.61449 5.03733C12.1544 7.5765 7.54266 8.48441 11.5317 12.4724Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-grow-rotate">
                                    Icon Grow Rotate
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.5899 11.8585C6.71614 12.0925 6.95618 12.2384 7.21726 12.2384H11.2827V20.2657C11.2827 20.671 11.604 21 12 21C12.3959 21 12.7172 20.671 12.7172 20.2657V12.2384H16.7827C17.0447 12.2384 17.2848 12.0925 17.4101 11.8585C17.5372 11.6245 17.5286 11.3386 17.39 11.1125L12.6073 3.34267C12.4753 3.12924 12.2467 3 12 3C11.7532 3 11.5247 3.12924 11.3927 3.34267L6.60998 11.1125C6.5373 11.2319 6.5 11.368 6.5 11.5041C6.5 11.6255 6.5306 11.7479 6.5899 11.8585Z" fill="currentColor"></path>
                                    </svg>
                                </Button>
                                <Button href="#" className="me-4  hvr-icon-float">
                                    Icon Float
                                    <svg className="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Col lg="12">
                    <Card>
                        ...
                        <Card.Body className="text-center">
                            <div className="iq-plugins-btn">
                                <Button href="#" className="me-4  hvr-border-fade">Border Fade</Button>
                                <Button href="#" className="me-4 hvr-hollow">Hollow</Button>
                                <Button href="#" className="me-4 hvr-trim">Trim</Button>
                                <Button href="#" className="me-4 hvr-ripple-out">Ripple Out</Button>
                                <Button href="#" className="me-4 hvr-ripple-in">Ripple In</Button>
                                <Button href="#" className="me-4 hvr-outline-out">Outline Out</Button>
                                <Button href="#" className="me-4 hvr-outline-in">Outline In</Button>
                                <Button href="#" className="me-4 hvr-round-corners">Round Corners</Button>
                                <Button href="#" className="me-4 hvr-underline-from-left">Underline From Left</Button>
                                <Button href="#" className="me-4 hvr-underline-from-center">Underline From Center</Button>
                                <Button href="#" className="me-4 hvr-underline-from-right">Underline From Right</Button>
                                <Button href="#" className="me-4 hvr-reveal">Reveal</Button>
                                <Button href="#" className="me-4 hvr-underline-reveal">Underline Reveal</Button>
                                <Button href="#" className="me-4 hvr-overline-reveal">Overline Reveal</Button>
                                <Button href="#" className="me-4 hvr-overline-from-left">Overline From Left</Button>
                                <Button href="#" className="me-4 hvr-overline-from-center">Overline From Center</Button>
                                <Button href="#" className="me-4 hvr-overline-from-right">Overline From Right</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col lg="12">
                    <Card>
                        <Card.Header>
                            <Card.Header.Title>
                                <h4>Shadow and Grow Transitions</h4>
                                <p>In this method, selecting only one option from a lots of options while only using up as much
                                    space as a single option excepted.</p>
                            </Card.Header.Title>
                        </Card.Header>
                        <Card.Body className="text-center">
                            <div className="iq-plugins-btn">
                                <Button href="#" className="me-4 hvr-shadow ">Shadow</Button>
                                <Button href="#" className="me-4 hvr-grow-shadow">Grow Shadow</Button>
                                <Button href="#" className="me-4 hvr-float-shadow">Float Shadow</Button>
                                <Button href="#" className="me-4 hvr-glow ">Glow</Button>
                                <Button href="#" className="me-4 hvr-shadow-radial">Shadow Radial</Button>
                                <Button href="#" className="me-4 hvr-box-shadow-outset ">Box Shadow Outset</Button>
                                <Button href="#" className="me-4 hvr-box-shadow-inset ">Box Shadow Inset</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card>
                        <Card.Header>
                            <Card.Header.Title>
                                ...
                                <p>In this method, selecting only one option from a lots of options while only using up as
                                    much space as a single option excepted.</p>
                            </Card.Header.Title>
                        </Card.Header>
                        <Card.Body className="text-center">
                            <div className="iq-plugins-btn">
                                <Button href="#" className="me-4 hvr-bubble-top">Bubble Top</Button>
                                <Button href="#" className="me-4 hvr-bubble-right">Bubble Right</Button>
                                <Button href="#" className="me-4 hvr-bubble-bottom">Bubble Bottom</Button>
                                <Button href="#" className="me-4 hvr-bubble-left">Bubble Left</Button>
                                <Button href="#" className="me-4 hvr-bubble-float-top">Bubble Float Top</Button>
                                <Button href="#" className="me-4 hvr-bubble-float-right">Bubble Float Right</Button>
                                <Button href="#" className="me-4 hvr-bubble-float-bottom">Bubble Float Bottom</Button>
                                <Button href="#" className="me-4 hvr-bubble-float-left">Bubble Float Left</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col lg="12">
                    <Card>
                        <Card.Header >
                            <Card.Header.Title>
                                <h4>Curls</h4>
                                <p>In this method, selecting only one option from a lots of options while only using up
                                    as much space as a single option excepted.</p>
                            </Card.Header.Title>
                        </Card.Header>
                        <Card.Body className="text-center">
                            <div className="iq-plugins-btn hrv-curl">
                                <Button href="#" className="me-4 hvr-curl-top-left">Curl Top Left</Button>
                                <Button href="#" className="me-4 hvr-curl-top-right">Curl Top Right</Button>
                                <Button href="#" className="me-4 hvr-curl-bottom-right">Curl Bottom Right</Button>
                                <Button href="#" className="me-4 hvr-curl-bottom-left">Curl Bottom Left</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
