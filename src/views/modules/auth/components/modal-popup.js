                    ...
                    <Modal.Body>
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-3">
                            <Form.Check className="form-check d-inline-block pt-1 mb-0">
                                ...
                                <Link to="/pro/auth/reset-password">Forget password</Link>
                        </div>
                        ...
                        <p className="text-center">Don't have account?<Link to="/pro/auth/sign-up" className="ms-2"> Click here to sign up.</Link></p>
                    </Modal.Body>
                </Modal>
            }
            {props.sign === 'up' &&
