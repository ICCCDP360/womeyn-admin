    ...
    return (
        ...
        <Fragment>
           <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <Nav.Item className={`${location.pathname === '/appointment/appointment' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/appointment/appointment' ? 'active' : ''} nav-link`} to="/appointment/appointment">
                        <i className="icon">
                ...
                <Nav.Item className={`${location.pathname === '/appointment/doctor-visit' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/appointment/doctor-visit' ? 'active' : ''} nav-link`} to="/appointment/doctor-visit">
                        ...
                        <span className="item-name">Doctor Visit</span>
                    </Link>
                </Nav.Item>
