...
const ProductCard = memo((props) => {
    ...
    return(
        <Fragment>
            <Card className="iq-product-custom-card animate:hover-media">
                <div className="iq-product-hover-img position-relative animate:hover-media-wrap">
                    <Link to="/e-commerce/product-details">
                        <Image src={props.productImage} alt="product-details" className="img-fluid iq-product-img hover-media   "/>
                    </Link>
                    <div className="iq-product-card-hover-effect-1 iq-product-info"  onClick={SweetalertOne} >
                        <Button href="#" variant="icon iq-product-btn rounded-pill wishlist-btn">
                        ...
                        <div className="iq-product-card-hover-effect-2 iq-product-info">
                            <Button href="#" variant="icon iq-product-btn rounded-pill" onClick={Sweetalert}>
                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Card.Body>
                    <div className="d-flex justify-content-between align-items-center mb-1">
                        <Link to="/e-commerce/product-details" className="h6 iq-product-detail mb-0">{props.productName}</Link>
                        {props.productRating &&
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        {props.productRating &&
                            <span>{props.productRating}k Ratings</span>
                        }
                    </div>
                </Card.Body>
            </Card>
