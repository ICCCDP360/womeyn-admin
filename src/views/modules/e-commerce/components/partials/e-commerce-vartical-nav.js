            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                <Nav.Item as="li" className="static-item">
                    <Nav.Link className="static-item disabled" href="#" tabIndex="-1">
                        <span className="default-icon">E-COMMERCE</span>
                        <span className="mini-icon">-</span>
                    </Nav.Link>
                </Nav.Item>
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/admin/admin-dashboard' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/admin/admin-dashboard' ? 'active' : ''} nav-link`} to="/e-commerce/admin/admin-dashboard">
                        <i className="icon">
                ...
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/user/vendor-dashbord' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/user/vendor-dashbord' ? 'active' : ''} nav-link`} to="/e-commerce/user/vendor-dashbord">
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">Vendor Dashboard</span>
                    </Link>
                </Nav.Item>
                <Accordion.Item as="li" bsPrefix={`nav-item  ${location.pathname === '/e-commerce/shop-main' || location.pathname === '/e-commerce/shop-left-filter' ? 'active' : '' || location.pathname === '/e-commerce/shop-right-filter' ? 'active' : '' || location.pathname === '/e-commerce/product-full-grid' ? 'active' : '' || location.pathname === '/e-commerce/product-list' ? 'active' : '' || location.pathname === '/e-commerce/categories-list' ? 'active' : '' || activeMenu === 'shop-main' ? 'active' : ''} `} >
                    <CustomToggle className="nav-link" eventKey="shop-main" active={activeMenu === 'shop-main' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)} >
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                    ...
                    <Accordion.Collapse eventKey="shop-main" >
                    <ul className="sub-nav " >
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/shop-main' ? 'active' : ''} nav-link`} to="/e-commerce/shop-main">
                                <i className="icon">
                                ...
                                <i className="sidenav-mini-icon"> SM </i>
                                <span className="item-name">Shop Main</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/shop-left-filter' ? 'active' : ''} nav-link`} to="/e-commerce/shop-left-filter">
                                <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span className="item-name">Shop - Left Filter</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/shop-right-filter' ? 'active' : ''} nav-link`} to="/e-commerce/shop-right-filter">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i className="sidenav-mini-icon"> SR </i>
                                <span className="item-name">Shop - Right Filter</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/product-full-grid' ? 'active' : ''} nav-link`} to="/e-commerce/product-full-grid">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i className="sidenav-mini-icon"> PG </i>
                                <span className="item-name">Product Grid View</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/product-list' ? 'active' : ''} nav-link`} to="/e-commerce/product-list">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i className="sidenav-mini-icon"> PL </i>
                                <span className="item-name">Product List View</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/categories-list' ? 'active' : ''} nav-link`} to="/e-commerce/categories-list">
                            <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <span className="item-name"> Categories List</span>
                            </Link>
                        </Nav.Item>
                    </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="products" bsPrefix={`nav-item   ${location.pathname === '/e-commerce/product-details' ? 'active' : '' || location.pathname === '/e-commerce/product-details-3d' ? 'active' : '' || location.pathname === '/e-commerce/product-details-360' ? 'active' : '' || activeMenu === 'products' ? 'active' : ''}`}  >
                    <CustomToggle eventKey="products"  onClick={(activeKey) => setActiveMenu(activeKey)} className="nav-link" >
                        <i className="icon">
                    ...
                    <ul className="sub-nav " >
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/product-details' ? 'active' : ''} nav-link`} to="/e-commerce/product-details">
                            <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <span className="item-name">Product Details</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li" >
                            <Link className={`${location.pathname === '/e-commerce/product-details-3d' ? 'active' : ''} nav-link`} to="/e-commerce/product-details-3d">
                                <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i className="sidenav-mini-icon"> 3D </i>
                                <span className="item-name">3D Product Detail</span>
                            </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                            <Link className={`${location.pathname === '/e-commerce/product-details-360' ? 'active' : ''} nav-link`} to="/e-commerce/product-details-360">
                            <i className="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i className="sidenav-mini-icon"> P </i>
                            <span className="item-name"> 360 Product Detail</span>
                            </Link>
                        </Nav.Item>
                    </ul>
                    </Accordion.Collapse>
                ...
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/order-process' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/order-process' ? 'active' : ''} nav-link`} to="/e-commerce/order-process">
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                        ...
                        <span className="item-name">Order Process</span>
                        <div>
                            <span className="badge bg-info rounded-pill d-inline-block">21</span>
                        </div>
                    </Link>
                </Nav.Item>
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/invoice' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/invoice' ? 'active' : ''} nav-link`} to="/e-commerce/invoice">
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                ...
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/wishlist' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/wishlist' ? 'active' : ''} nav-link`} to="/e-commerce/wishlist">
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name"> Wishlist</span>
                    </Link>
                </Nav.Item>
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/app/user-profile' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/app/user-profile' ? 'active' : ''} nav-link`} to="/e-commerce/app/user-profile">
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Nav.Item as="li" className={`${location.pathname === '/e-commerce/app/user-list' ? 'active' : ''}`}>
                    <Link className={`${location.pathname === '/e-commerce/app/user-list' ? 'active' : ''} nav-link`} to="/e-commerce/app/user-list">
                        <i className="icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
