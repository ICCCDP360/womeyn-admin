...
const ProductCardListView = memo((props) => {
    ...
    return(
        <Fragment>
            <Card className="iq-product-list-view">
                <Card.Body className=" d-flex flex-wrap justify-content-between">
                    <div className="iq-product-list-left-side d-flex flex-wrap align-items-center trending-card">
                        <Image src={props.productImage} alt="product-details" className="img-fluid trending-img iq-product-img"/>
                        <div className="iq-list-view-left trending-details ms-3">
                            <Link to="/e-commerce/product-details" className="h5 mb-3 d-block iq-product-detail">{props.productName}</Link>                          
                                <h4 className="mb-3">{props.productPrice}</h4>
                            <div>
                                <div className="d-flex align-items-center">
                                    ...
                                    <small className="ms-2">{props.productRating}k Ratings</small>
                                </div>
                            </div>
                                <Counter/>
                        </div>
                    </div>
                    <div className="iq-list-view-right d-flex flex-column trending-details1 justify-content-center align-items-end">
                        <div>
                        <span className={`bg-soft-${props.statusColor} badge rounded-pill p-2 px-3`}>{props.statusIdentity}</span>
                        </div>
                        <div className="d-flex flex-column text-end">
                            <span>Delivery by, {props.deliveryDate}</span>
                        </div>
                        <div className="iq-list-options d-flex align-items-end gap-2">
                            <Button className="btn btn-info d-flex align-items-center cart-btn gap-2" onClick={Sweetalert}>
                                <span>
                            ...
                            <Button className="btn btn-primary d-flex align-items-center cart-btn  gap-2" onClick={SweetalertOne}>
                                <span>
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
ProductCardListView.displayName="ProductCardListView"
