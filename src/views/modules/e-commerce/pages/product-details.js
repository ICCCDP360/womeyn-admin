                                    ...
                                    <div className="slider__flex">
                                                ...
                                                >
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                                            <Image alt="product-15" src={img14} />
                                                        </div>
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                                            <Image alt="product-16" src={img15} />
                                                        </div>
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                                            <Image alt="product-17" src={img16} />
                                                        </div>
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <div className="slider__image"> 
                                                            <Image alt="product-17" src={img17} />
                                                        </div>
                                                    </SwiperSlide>
                                                </Swiper>
                                            </div>
                                        ...
                                        <div className="slider__images">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div className="slider__image">
                                                        <Image alt="product-15" src={img18} />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div className="slider__image">
                                                        <Image alt="product-16" src={img14} />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div className="slider__image">
                                                        <Image alt="product-17" src={img15} />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div className="slider__image">
                            ...
                            <Col lg="5">
                                <div className="border-bottom">
                                    ...
                                    <div className="d-flex my-4">
                                        ...
                                        <h4 className="text-primary mb-0 ms-2">$49.99</h4>
                                    </div>
                                </div>
                                <div className="border-bottom">
