            ...
            <div className="mt-5 mb-4">
                <div className="d-flex justify-content-between align-items-center">
                        ...
                        <ul className="nav nav-pills mb-0 iq-product-filter d-flex bg-transparent align-items-center" id="pills-tab" role="tablist">
                            ...
                            <li className="nav-item ms-2" role="presentation">
                                <Button bsPrefix="nav-link btn btn-sm btn-icon rounded-pill " id="grid-view-tab" data-bs-toggle="pill" data-bs-target="#pills-grid-view" to="#" role="tab" aria-controls="pills-grid-view" aria-selected="true">
                            ...
                            <li className="nav-item ms-2" role="presentation">
                                <Button bsPrefix="nav-link btn btn-sm btn-icon rounded-pill active" id="list-view-tab" data-bs-toggle="pill" data-bs-target="#pills-list-view" to="#" role="tab" aria-controls="pills-list-view" aria-selected="false">
                                    <span className="btn-inner">
                                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Col lg="12" className="pt-4">
                    <div className="tab-content" id="pills-tabContent">
                        <div className="tab-pane fade  show active" id="pills-list-view" role="tabpanel" aria-labelledby="list-view-tab">
                        ...
                        <div className="tab-pane fade" id="pills-grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
