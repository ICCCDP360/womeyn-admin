...
// React-bootstrap
import { Row, Col, Button, Image, Tab, Nav, Modal, Form ,Table} from "react-bootstrap";
        ...
        <Col lg="12">
            <Card>
                <Card.Body>
                    <Row>
                        <Col lg="7">
                        <div className="product-slider slider-circle-btn">
                            <Swiper
                            modules={[Navigation]}
                            slidesPerView= {1}
                            navigation={{
                        ...
                        <Modal  show={show} onHide={handleClose} size="xl" contentClassName="bg-transparent border-0 shadow-none">
                            <Modal.Header className="border-0  d-flex justify-content-end">
                                <Button variant="light m-2"  onClick={handleClose}>close</Button>
                            </Modal.Header>
                            <Modal.Body>
                                <Row>
                        ...
                        <Col lg="5">
                            ...
                            <Counter />
                                <div className="d-flex py-4 flex-wrap gap-4">
                                    ...
                                    <button  className="btn btn-primary d-flex align-items-center cart-btn  gap-2" onClick={Sweetalert}>
                                        <span className="btn-inner d-flex">
                                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="d-flex flex-sm-nowrap flex-wrap">
                                                ...
                                                <div className="ms-0 ms-sm-3">
                                                    ...
                                                    <div className="d-flex">
                                                        <button type="submit" className="btn btn-primary rounded">Get Started</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </Card.Body>
                                    ...
                                    <Row>
                                        <Col lg="6">
                                            <div className="form-group">
                                                ...
                                                <Form.Control type="text" className="fw-100" id="full-name" placeholder=" John" />
                                            </div>
                                        </Col>
                                        <Col lg="6">
                                            <div className="form-group">
        ...
        <Col lg="12" md="12">
            <Row className="row-cols-1">
                ...
                <div className="overflow-hidden slider-circle-btn" id="ecommerce-slider">
                    ...
                    <div id="swiper-button-next" className="swiper-button swiper-button-next"></div>
                    <div id="swiper-button-prev" className="swiper-button swiper-button-prev"></div>
                </div>
            </Row>
        </Col>
      </Row>
