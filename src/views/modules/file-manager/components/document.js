...
//React-bootstrap
import {Image,Dropdown,Modal} from 'react-bootstrap'
        ...
        <Fragment>
            <Card className=" iq-file-manager">
                <Card.Body>
                        <div className="p-3 d-flex justify-content-center align-items-center iq-document rounded bg-body">
                            <Image src={props.imgChange} className="img-fluid" alt="" onClick={handleShow}/>
                        </div>
                    <div className="mt-2">
            ...
            <Modal show={show} onHide={handleClose} size="xl">
                ...
                <Modal.Body className="text-center"> 
                    {props.media === "pdf" &&
                        <iframe src="https://templates.iqonic.design/hope-ui/pro/html/file-manager/assets/images/doc-files/demo.pdf" title="iq-doc" loading="lazy" style={{width: '69rem', height: '34rem'}}>
                        </iframe>
                    }
                    {props.media === "xlxs" &&
                        <iframe src="https://view.officeapps.live.com/op/view.aspx?src=https://templates.iqonic.design/hope-ui/pro/html/file-manager/assets/images/doc-files/demo.xlsx" title="iq-doc" loading="lazy" style={{width: '69rem', height: '34rem'}}>
                        </iframe>
                    }
                    {props.media === "word" &&
                        <iframe src="https://view.officeapps.live.com/op/view.aspx?src=https://templates.iqonic.design/hope-ui/pro/html/file-manager/assets/images/doc-files/demo.docx" title="iq-doc" loading="lazy" style={{width: '69rem', height: '34rem'}}>
                        </iframe>
                    }
                </Modal.Body>
            </Modal>
