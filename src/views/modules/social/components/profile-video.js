...
const Socialprofilevideo = memo((props) => {
    return (
        <Fragment>
            <div className="user-images position-relative overflow-hidden">
                <div className="ratio ratio-16x9">
                    <iframe title="video" loading="lazy" src={props.profilevideosrc} allowFullScreen></iframe>
                </div>
                <div className="image-hover-data">
                    <div className="product-elements-icon">
                        <ul className="d-flex align-items-center m-0 p-0 list-inline">
                            <li><Link to="#" className="text-white d-flex justify-content-center align-items-center">
                                {props.profilevideodetail1}
                ...
                <Link to="#" className="image-edit-btn image-edit-btn btn bg-white btn-sm btn-icon position-absolute">
...
Socialprofilevideo.displayName="Socialprofilevideo"
export default Socialprofilevideo