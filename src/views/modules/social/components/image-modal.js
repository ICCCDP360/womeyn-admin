...
const Imagemodal = memo((props) => {
    return (
        <Fragment>
            <Modal className="iq-modal" show={props.show} onHide={props.onclick} dialogClassName="modal-fullscreen-sm-down modal-fullscreen-lx-down image-modal" >
                <div className="model-header relative">
                    <Button variant="close" style={{position: 'absolute', right:'0', zIndex: '1', padding: '10px'}} onClick={props.onclick} ></Button>
                </div>
                <Modal.Body className="p-0">
                    <div className="d-flex gap-2">
                        <div >
                            <Card style={{height:'100%', width:'100%'}} >
                                <Image src={img1} className="img-fluid" alt="post-image" style={{height:'100%', width:'100%'}}  loading="lazy" />
                            </Card>
                        </div>
                        <div className=" mt-4">
                            <Card className=" mb-0">
                                ...
                                <Card.Body>
                                    <ul className="list-inline mb-0">
                                        <li className="mb-4">
                                            <Friendcomment userName="Larry Robbins" userComment="Great Picture Loved It." commentDuration="5 Min Ago" userImage={img3}/>
                                        </li>
                                        <li className="mb-4">
                                            <Friendcomment userName="David Willey" userComment="Wow nice place." commentDuration="10 Min Ago" userImage={img4}/>
                                        </li>
                                        <li>
                                            <Friendcomment userName="Chaeyoung Park" userComment="Loved It" commentDuration="25 Min Ago" userImage={img5}/>
                                        </li>
                                    </ul>
                                </Card.Body>
