                            ...
                            <div className="w-100">
                                <div className="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <p className="mb-0">{props.notificationdefault}</p>
                                    </div>
                                    <div className="d-flex align-items-center gap-2">
                                        ...
                                        <div className="card-header-toolbar d-flex align-items-center">
                                            <Dropdown>
                                                <Dropdown.Toggle as='svg' width="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentcolor">
                                                ...
                                                <Dropdown.Menu className=" dropdown-menu-right">
                                                    <Dropdown.Item className=" d-flex align-items-center"  >
                                                        <svg width="18" viewBox="0 0 24 24" className="me-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <Dropdown.Item className=" d-flex align-items-center">
                                                        <svg width="15" viewBox="0 0 24 24" className="me-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <svg width="18" viewBox="0 0 24 24" className="me-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        Print</Dropdown.Item>
                                                    <Dropdown.Item className="d-flex align-items-center"  >
                                                    <svg width="18" viewBox="0 0 24 24" className="me-3" fill="none" xmlns="http://www.w3.org/2000/svg">
