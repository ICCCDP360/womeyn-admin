            ...
            <div className="card-header d-flex  justify-content-between">
                <div className="header-title">
                    <div className="d-flex justify-content-center flex-wrap">
                        <div className="me-3">
                            <img className="img-fluid rounded-circle p-1 border border-2 border-primary border-dotted avatar-50" src={props.userprofile} alt="profile-img" loading="lazy" />
                        </div>
                        <div className="media-support-info">
                            <div className="d-flex align-items-center mb-2">
                                <h6 className="mb-0 me-2">{props.userName}</h6>
                                <small className="text-dark">{props.postStatus}</small>
                            </div>
                            <p className="mb-0 text-muted">{props.postDuration} Ago</p>
                        </div>
                    </div>
                </div>
                <Dropdown>
