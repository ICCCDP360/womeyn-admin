            ...
            <div className="d-flex flex-wrap justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-3">
                    <div className="total-like-block">
                        <Dropdown>
                            <Dropdown.Toggle as={CustomToggle} variant="text-body d-flex align-items-center gap-2" >
                                ...
                                <span className=" d-none d-sm-block">{props.noLikes} Likes</span>
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                    ...
                    <div className="total-comment-block">
                        <Dropdown>
                            <Dropdown.Toggle as={CustomToggle}  variant="text-body d-flex align-items-center gap-2">
                                ...
                                <span className=" d-none d-sm-block">{props.noComments} Comments</span>
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                                <Dropdown.Item>Max Emum</Dropdown.Item>
                                <Dropdown.Item>Bill Yerds</Dropdown.Item>
                ...
                <Link to="#" onClick={() => setSave(!save)} className={`d-flex align-items-center gap-2 text-body save ${save === true ? 'active' : ''} `}>
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
