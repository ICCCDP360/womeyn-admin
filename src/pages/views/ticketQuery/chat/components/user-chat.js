...
const UserChat = memo((props) => {
  return (
    <Fragment>
      <div
        className={`d-flex last-chats-body nav-link align-items-center ${props.className}`}
        role="tab"
        data-bs-toggle="pill"
              ...
              {props.muted && (
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M9.61069 5.88917L3.92792 11.5724C3.78022 11.4868 3.64029 11.4324 3.5159 11.4246C2.43532 11.3469 2.01553 11.4713 1.42471 10.9659C0.787246 10.4217 0.83389 8.96789 0.83389 7.90278C0.83389 6.83767 0.787246 5.38383 1.42471 4.83961C2.01553 4.33427 2.43532 4.46643 3.5159 4.38091C4.59648 4.29539 6.88203 0.998989 8.64672 2.04078C9.36192 2.62387 9.55627 3.7123 9.61069 5.88917Z"
                    stroke="currentcolor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M9.61069 9.59758C9.57959 11.9921 9.39302 13.1583 8.64672 13.7647C7.83045 14.2468 6.90535 13.8036 6.03467 13.1739"
                    stroke="currentcolor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M0.834351 14.6666L3.92838 11.5724L9.61115 5.88917L14.1667 1.33329"
                    stroke="currentcolor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
