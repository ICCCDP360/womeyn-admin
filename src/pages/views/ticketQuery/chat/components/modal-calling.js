      ...
      <Modal show={props.show} onHide={props.handleClose}>
        ...
        <Modal.Body>
          <div className="d-flex justify-content-between align-items-center pb-3 border-bottom">
            <Form.Check.Label className="mb-0" htmlFor="call-001">
              Caller ID
            </Form.Check.Label>
          ...
          <div className="d-flex justify-content-between align-items-center pt-3 pb-3 border-bottom">
            <Form.Check.Label className="mb-0" htmlFor="call-002">
              Call Forwarding and Voicemall
            </Form.Check.Label>
            <div className="form-check form-switch mb-0">
          ...
          <div className="d-flex justify-content-between align-items-center pt-3 pb-3 border-bottom">
            <Form.Check.Label className="mb-0" htmlFor="call-003">
              Show Call Window When Hope UI is in the background
            </Form.Check.Label>
            <div className="form-check form-switch mb-0">
          ...
          <div className="d-flex justify-content-between align-items-center pt-3">
            <Form.Check.Label
              ...
              htmlFor="call-004"
            >
              Only allow Hope UI calls from contacts to ring on this device
            </Form.Check.Label>
            <div className="form-check form-switch mb-0">
