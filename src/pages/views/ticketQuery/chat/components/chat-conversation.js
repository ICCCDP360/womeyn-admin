...
const ChatConversation = memo((props) => {
  return (
    <Fragment>
      <div
        className={`card tab-pane fade ${props.className}`}
      ...
      >
        <Card.Header className="border-bottom chat-content-header  pb-3">
          <div className="d-flex align-items-center">
            <Button
              className="btn-sm d-block d-lg-none mr-2"
            ...
            {props.chatConversationImg && (
              <div
                className="avatar-50 avatar-borderd avatar-rounded bg-white chat-profile-1"
                onClick={() => {
                  props.chatConversation();
                }}
              >
                <img
                  src={props.chatConversationImg}
                  alt="users"
                  className="img-fluid"
                  loading="lazy"
                />
            ...
            {props.chatConversationIcon && (
              <div
                className="p-2 bg-white rounded-circle chat-profile-1"
                onClick={() => {
                  props.chatConversation();
                }}
              >
          ...
          <div className="chat-action">
            <div className="d-flex align-items-center" role="tablist">
              ...
              {/* <Dropdown className="ms-3">
                ...
                <Dropdown.Menu
                  aria-labelledby={`drop-down- ${props.dropdownId}`}
                >
          ...
          <Dropdown className="chat-action-responsive d-none">
            <Dropdown.Toggle
              ...
              id={`dropdownMenuButton ${props.dropdownId}`}
              aria-expanded="false"
              width="5"
              height="20"
              viewBox="0 0 5 20"
            ...
            {/* <Dropdown.Menu
              aria-labelledby={`dropdownMenuButton ${props.dropdownId}`}
            >
              <li>
        ...
        <Card.Body className="c.js">
          ...
          <div className="chat-left mt-4">
            <div>
              <p className="mb-0">
                See....! <Link to="/dashboard">Design System</Link>{" "}
              </p>
            </div>
          ...
          <div className="chat-left">
            <div className="d-flex mb-1">
              <p className="mb-0">
                Lets meet we’ll discuss about the projects and let then tell the
                team about the ideas
              </p>
            </div>
            <div className="d-flex justify-content-end">
              <small>10.00pm</small>
          ...
          <div className="d-flex justify-content-end">
            <div className="chat-right mt-4">
              <div className="chat-text">
                <p className="mb-0">
                  Lets meet we’ll discuss about the projects
                </p>
              </div>
              <div className="d-flex justify-content-end align-items-center">
                <span className="text-success">
