      ...
      <div className="tab-content">
        ...
        >
          ...
          <Card.Body className="bg-body chat-body">
            ...
            <Leftchat
              ...
              messageTime="16:40"
              userImg={img3}
              message="Hey, I am looking for the best dashboard template. Could you please help me to find it out?"
            />
            <Rightchat
              username="Ross Taylor"
              messageTime="16:42"
              userImg={img2}
              message="Absolutely Yes! Hope-UI is the Responsive Bootstrap 5 Admin Dashboard Template."
            />
            <Leftchat
              username="Ellyse Perry"
              messageTime="17:00"
            ...
            <Leftchat
              ...
              messageTime="12:00"
              userImg={img3}
              message="This are nice pics."
            />
            <Leftchat
              username="Ellyse Perry"
              messageTime="12:05"
              userImg={img3}
              message="I want some teachnic for fast code can you help?"
            />
            <Rightchat
              username="Ross Taylor"
              messageTime="13:10"
        ...
        >
          <Chatheader
            ...
            userProfileImg={img1}
            tatus="Last seen 10 min ago"
            statusidentify="offline"
          />
          <Card.Body className="chat-body bg-body">
            ...
            <Leftchat
              ...
              messageTime="12:00"
              userImg={img1}
              message="Nice place for holiday."
            />
            <Leftchat
              username="Faf Du Plessis"
              messageTime="12:05"
              userImg={img1}
              message="Where is this place came?"
            />
            <Rightchat
              username="Ross Taylor"
              messageTime="13:10"
              userImg={img2}
              message="This place name is devi pada."
            />
            <div></div>
            <Leftchat
              username="Faf Du Plessis"
              messageTime="15:00"
              userImg={img1}
              message="Okay, I will visit this place."
            />
          </Card.Body>
          <Chatfooter />
        </Card>
        ...
        <Card
          className={`${
            props.show === "10" ? "active" : ""
          }  mb-0 fade show tab-pane`}
          role="tabpanel"
        >
          <Chatheader
            userName="Rachel Green"
            userProfileImg={img11}
            status="Online"
            status-identify="online"
          />
          <Card.Body className="chat-body bg-body">
