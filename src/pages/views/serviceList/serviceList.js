                  ...
                  >
                    ...
                    >
                      <span className="iq-mail-section">
                        New Services({pendingList.TotalServicesCount})
                      </span>
                    </Nav.Link>
                    <Nav.Link
                      eventKey="2"
                    ...
                    >
                      <span className="iq-mail-section">
                        Service Update({pendingList.TotalServicesUpdatedCount})
                      </span>
                    </Nav.Link>
                  </div>
                </Nav>
                                                ...
                                                >
                                                  {item?.serviceImages ? (
                                                    <img
                                                      ...
                                                      src={`https://my-demo-11-bucket.s3.ap-south-1.amazonaws.com/${item.serviceImages}`}
                                                      alt=""
                                                      loading="lazy"
                                                    />
                                                  ) : (
