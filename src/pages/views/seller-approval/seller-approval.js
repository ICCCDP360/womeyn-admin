  ...
  const table = [
    {
      ...
      contact: 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.',
                ...
                {table.map((item, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td className="text-dark no-wrap">{item.contact}</td>
                      ...
                      <td>
                        <div className="d-flex gap-3 justify-content-center">
                          ...
                          <Link
                            ...
                            role="button"
                          >
                            <span className="btn-inner">{item.actionedit}</span>
                          </Link>
                          <Link
                            className="btn btn-primary btn-icon btn-sm rounded-pill"
                            to="/blog/blog-category"
