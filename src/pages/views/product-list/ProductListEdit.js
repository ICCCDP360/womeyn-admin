                                    ...
                                    <div className="slider__flex">
                                                ...
                                                >
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                                            <Image alt="product-15" src={single?.img} style={{ objectFit: "cover" }} />
                                                        </div>
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                                            <Image alt="product-16" src={single?.img} style={{ objectFit: "cover" }} />
                                                        </div>
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                                            <Image alt="product-17" src={single?.img} style={{ objectFit: "cover" }} />
                                                        </div>
                                                    </SwiperSlide>
                                                    <SwiperSlide>
                                                        <div className="slider__image">
                                        ...
                                        <div className="slider__images">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div className="slider__image">
                                                        <Image alt="product-15" src={single?.img} style={{ objectFit: "contain", width: "100%" }} />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div className="slider__image">
                                                        <Image alt="product-16" src={single?.img} style={{ objectFit: "cover", width: "100%" }} />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div className="slider__image">
                                                        <Image alt="product-17" src={single?.img} style={{ objectFit: "cover", width: "100%" }} />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div className="slider__image">
                            ...
                            <Col lg="5">
                                <div className="border-bottom">
                                    <div className="d-flex flex-column align-content-between justify-items-center mb-3">
                                        <div className="d-flex justify-content-between mb-2">
                                            <h2 className="mb-0">{single.name}</h2>
                                    ...
                                    <div className="d-flex my-4">
                                        ...
                                        <h4 className="text-primary mb-0 ms-2">$ {single.price}</h4>
                                    </div>
                                </div>
                                <div className="border-bottom">
                                ...
                                {/* <div className="d-flex flex-column py-4">
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <span className="text-primary  ms-2">Friday, March 04</span>
                                    </div>
                                    <div className="d-flex align-items-center mb-3">
                                ...
                                <Tab.Pane eventKey="thired" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                                        ...
                                        <Card className="shadow-none bg-transparent border">
                                            <Card.Body>
                                                <div className="d-flex flex-sm-nowrap flex-wrap">
                                                    <div>
                                                        <Image className="img-fluid object-contain avatar-120 rounded" src={single?.img} alt="01" loading="lazy" />
                                                    </div>
                                    ...
                                    <form>
                                        <Row>
                                            ...
                                            <Col lg="6">
                                                <div className="form-group">
                                                    <Form.Label htmlFor="last-name" className="form-label">Email ID<span className="text-danger">*</span></Form.Label>
