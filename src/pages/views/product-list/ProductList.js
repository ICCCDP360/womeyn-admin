                    ...
                    <Card style={{ padding: "0px", }}>
                        <Card.Header className="d-flex justify-content-between">
                            ...
                            <div className='mt-3' style={{ marginRight: "2%" }}>
                                <Button onClick={() => history(`/womeyn/addproduct`)}>
                                    + Add New Product
                                </Button>
                            </div>
                        ...
                        <div className='d-flex justify-content-end mb-2 mt-2'>
                            <div style={{ paddingRight: "5%" }}>
                                <div className="form-group input-group mb-0 search-input" style={{ background: "#F9F9F9" }}>
                                    <Form.Control type="text" placeholder="Search Product Name" name="ProductName" value={serach} onChange={(e) => setSearch(e.target.value)} />
                                    <span className="input-group-text" style={{ background: "#F9F9F9" }}>
                                        ...
                                        {table1.filter((itemsed) =>
                                            ...
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <span className={`badge rounded-pill bg-soft-${item.bgColor} p-2 text-${item.statusColor}`}>{item.status}</span>
                                                    </td>
                                                    <td>
                                                        <div className="d-flex justify-content-evenly">
                                                            ...
                                                            <Button className="btn btn-primary btn-icon btn-sm rounded-pill ms-2" role="button" onClick={() => history(`/womeyn/product-list-edit/${item.id}`)}>
                                                                <span className="btn-inner">
                                                                    {item.actionedit}
                                                                </span>
                                                            </Button>
