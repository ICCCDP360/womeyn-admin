...
const TopServiceCategory = memo((props) => {
  console.log("first", props.props);
  const [show, setShow] = useState(false);
  const [options, setOptions] = useState([{ value: "", label: "", id: "" }]);
  const [topServiceCategory, setTopServiceCategory] = useState();
  ...
  useEffect(() => {
    setAddStatus(false);
    if (props.props === "Top Service Category") {
      services();
      getCategory();
    }
  }, [addStatus]);
  ...
  return (
    <Fragment className="mb-7">
      ...
      >
        <div>
          {props.props === "Top Service Category" ? (
            <div className="mt-5">
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <Button onClick={() => handleShow()}>
                  + Select New Service Category
                </Button>
              </div>
              <Row>
                {topServiceCategory.map((item) => {
        ...
        >
          ...
          <Modal.Footer>
            ...
            <Button variant="primary" onClick={selectServiceCategory}>
              {loading ? (
                <span
...
export default TopServiceCategory;
