...
import download from "../../../../assets/loginLogos/download file.png";
import print from "../../../../assets/loginLogos/print.png";
import "../allorderdetails/styles/Allorders.scss";

// const ref = React.createRef();

function OrderInvoice() {
  const invoiceDoc = useRef(null);
  ...
  const handleGeneratePdf = () => {
    ...
    doc.html(invoiceDoc.current, {
      async callback(doc) {
        // save the document as a PDF with name of Memes
        doc.save("product_invoice");
      },
    });
  };
    ...
    <Fragment>
      <div className="p-3">
        ...
        <div className="d-flex justify-content-between">
          <div>
            <Button className="invoiceprint" onClick={handleGeneratePdf}>
          ...
          {/* <Pdf targetRef={ref} filename="product_invoice.pdf">
            {({ toPdf }) => (
              <Button className="invoiceprint" onClick={toPdf}>
                <div className="d-flex gap-3">
                  <div>Download Invoice</div>
                  <div>
                    <span>
