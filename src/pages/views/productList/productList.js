...
import {
  ApprovedSellerServices,
  getProductContentUpdatedServices,
...
const ProductList = memo((props) => {
  ...
  useEffect(() => {
    ...
    getProductContentUpdatedServices()
      .then((res) => {
        console.log("content updated", res.data.results);
  ...
  const handleSeller = (selectedSeller) => {
    setSelectedOption(selectedSeller.value);
    console.log("selectedOption", selectedSeller.value);
  };
                  ...
                  >
                    ...
                    >
                      <span className="iq-mail-section">
                        New Products({pendingList.TotalProductsCount})
                      </span>
                    </Nav.Link>
                    <Nav.Link
                      eventKey="2"
                    ...
                    >
                      <span className="iq-mail-section">
                        Product Update({pendingList.TotalProductsUpdatedCount})
                      </span>
                    </Nav.Link>
                  </div>
                </Nav>
                          ...
                          <Row>
                            <Col sm="12">
                              ...
                              >
                                ...
                                <Modal.Body>
                                  <h6 className="mb-5">
                                    Are you really want to reject the product?
                                  </h6>
                                  <div className="field-container">
                                    <Form.Label htmlFor="validationServer01">
                                      <h6>Reason for Rejection:</h6>
                              ...
                              >
                                ...
                                <Modal.Body>
                                  Are you really want to approve the Product?
                                </Modal.Body>
                                <Modal.Footer>
                                  <Button
                                    variant="secondary"
